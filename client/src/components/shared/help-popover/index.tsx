    ...
    <div onClick={(e) => e.stopPropagation()}>
      ...
      <RenderIf condition={isOpen}>
        <div
          ...
          className="z-50 fixed bottom-[calc(4rem+1.5rem)] right-0 mr-4 bg-white p-6 rounded-lg border border-[#e5e7eb] w-[440px] h-[635px]"
        >
          <div className="flex flex-col space-y-1.5 pb-6">
            <h2 className="font-semibold text-lg tracking-tight">
              Xeyir Help Chat
            </h2>
            <p className="text-sm text-[#6b7280] leading-3">Powered by Xeyir</p>
          </div>
